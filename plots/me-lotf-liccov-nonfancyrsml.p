...
set logscale y
plot 'me-lotf-liccov-steps.dat' using 1:2 title 'ö_{S_{isol}}' lc rgb 'brown' with linespoints,\
'me-lotf-nonfancyrsml-PInputMean-b5-steps.dat' using 1:2 title 'o_{NFRSML} (b=5)' lc rgb 'black' with linespoints,\
 'me-lotf-nonfancyrsml-steps.dat' using 1:2 title 'o_{NFRSML} (b=10)' lc rgb 'grey70' with linespoints
