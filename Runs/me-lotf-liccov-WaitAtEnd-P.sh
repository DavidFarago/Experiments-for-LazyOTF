...
do
    ...
    evaluate /raid/farago/Experiments/Skeletons/Gen3_Bare_LazyOTF.jtorx  /raid/farago/Experiments/Skeletons/licenseGenerator3Skel.sax $count $MAXSTEP $SAMPLE "liccov-lazyotfto;0;$count;use-dist-hazel;${INSTANCES};${CLUSTERID};sleep-before-hc-shutdown;75000;sleep-before-hc-shutdown-max-ratio;1;max-wait-before-forcing-jvm-shutdown;115000;" lazyotf
    count=`expr $count + 1`
done
...
#   log-level;WARNING,SEVER,INFO,ALL
