...
do
    ...
    evaluate /raid/farago/Experiments/Skeletons/Gen3_NonFancyRSML.jtorx  /raid/farago/Experiments/Skeletons/licenseGenerator3Skel.sax $count $MAXSTEP $SAMPLE "use-dist-hazel;${INSTANCES};${CLUSTERID};" lazyotf $DEPTH $DEPTH $THRESH
    count=`expr $count + 1`
done
