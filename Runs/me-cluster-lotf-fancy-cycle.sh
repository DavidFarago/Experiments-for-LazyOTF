...
submitjob() {
    ...
    qsub -N $NAME$TR -o /home/farago/$NAME-out -e /home/farago/$NAME-err -V -v "ARGMIN=$AARGMIN,ARGMAX=$AARGMAX,SIZE=$ASIZE,STEPCEIL=$ASTEPCEIL,EXPERIMENT=$EXPERIMENT,TREETOWEIGHT=$AWTC,TR=$TR" -l walltime=50:00:00,nodes=1:ppn=1 Cluster_ExecExp.sh
}
...
defaultrun() {
    ...
    submitjob me-lotf-liccov-cycle.sh $D_ARGMIN $D_ARGMAX $D_SAMPLESIZE $D_STEPCEIL
    submitjob me-lotf-rsml-cycle.sh $D_ARGMIN $D_ARGMAX $D_SAMPLESIZE $D_STEPCEIL
    submitjob me-lotf-cov-cycle.sh $D_ARGMIN $D_ARGMAX $D_SAMPLESIZE $D_STEPCEIL
...
do
  defaultrun
  #testrun
  #submitjob me-lotf-rsml-cov-AWTC.sh 1 10 10 40000000
  #decrun
