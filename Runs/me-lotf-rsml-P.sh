...
do
    ...
    evaluate /raid/farago/Experiments/Skeletons/Gen3_ReachShowMoreLicensesWOInducing_LazyOTF.jtorx  /raid/farago/Experiments/Skeletons/licenseGenerator3Skel.sax $count $MAXSTEP $SAMPLE "use-dist-hazel;${INSTANCES};${CLUSTERID};" lazyotf
    count=`expr $count + 1`
done
