...
do
    ...
    evaluate /raid/farago/Experiments/Skeletons/Gen3_Bare_LazyOTF.jtorx  /raid/farago/Experiments/Skeletons/licenseGenerator3Skel.sax $count $MAXSTEP $SAMPLE "liccov-lazyotfto;0;$count;use-dist-hazel;${INSTANCES};${CLUSTERID};" lazyotf
    count=`expr $count + 1`
done
