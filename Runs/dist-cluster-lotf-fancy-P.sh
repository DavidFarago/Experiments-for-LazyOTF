...
defaultrun() {
    ...
    submitjob me-lotf-rsml-P.sh $D_ARGMIN $D_ARGMAX $D_SAMPLESIZE $D_STEPCEIL $INSTANCES
    submitjob me-lotf-cov-P.sh $D_ARGMIN $D_ARGMAX $D_SAMPLESIZE $D_STEPCEIL $INSTANCES
    submitjob me-lotf-rsml-cov-P.sh $D_ARGMIN $D_ARGMAX $D_SAMPLESIZE $D_STEPCEIL $INSTANCES
    submitjob me-lotf-liccov-P.sh $D_ARGMIN $D_ARGMAX $D_SAMPLESIZE $D_STEPCEIL $INSTANCES
}
...
do
  # testrun
  echo starting $THECOUNT of $THERUNS at `date +%H:%M:%S`
  defaultrun
